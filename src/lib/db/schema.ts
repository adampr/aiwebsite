...
// "0 published" while the company publicly showcased their tool.
//
...
// Migration 0050 creates this table EMPTY for exactly that reason, and the
// rows are written on the VM. Do not add a seed anywhere.
//
...
// this table only when scope.companyId is null.
//
