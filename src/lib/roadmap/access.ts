 ...
 * request aggregates are visible to any verified xl.net staff session on
 ...
 * this predicate requires a verified staff provider, and the mv requirement
 * on the Microsoft lane is what closes the nOAuth path). Anything that
