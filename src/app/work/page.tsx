    ...
    <div className="work-page mx-auto max-w-5xl space-y-16">
      ...
      <section aria-label="Client Delivery" className="space-y-16">
        ...
        {/* Placed team cards (placements.ts): today bay 03 holds THREE
            ...
            with #team-mycoach at 10), so the four static exhibits after
            this slot (#lakehouse .. #beacon, at 16-19) carry classes
            flipped for them; all four keep the class 6e45b44 (the
            #follow-up-emails conversion) left them with. #autotask-ci-intake,
            formerly the last static at 20, retired 2026-09-08 (one tool,
            one card). */}
