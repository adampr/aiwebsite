      ...
      <section className="mx-auto max-w-5xl px-6">
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          <div className="panel rise" style={{ transitionDelay: "100ms" }}>
            ...
            <p className="mt-4 text-sm">
              A private portal for your whole company: eleven steps from an AI
              ...
              people claim and ship them; then give those builders a
              sanctioned platform, the data they need, and the tools you have
              approved. Nine steps are free, two are paid training. Sign in
              with a work email; your roadmap is visible only to your company.
            </p>
