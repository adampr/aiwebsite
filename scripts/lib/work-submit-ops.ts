...
export const SUBMIT_GATES: readonly GateSpec[] = [
  ...
  { id: "published_title_clash", route: "366-408", what: "static exhibit titles + publishedTitleClash (with the already-published sha split)" },
  { id: "active_title_clash", route: "409-422", what: "activeTitleClash" },
