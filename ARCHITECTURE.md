...
worst case ≈19.2 MB inside Resend's 40 MB cap. The §5.12 bounce WARN is
deliberately unchanged as the regression alarm if a provider ever starts
bouncing the armor itself. Every list/poll/panel query excludes the byte
columns (`ROW_COLS`).
