...
2026-08-04**, owner directive "the MD file should be sufficient to describe what
...
pre-sniffed (2026-08-04, owner directive "zip files should be inspected"):** the
...
"non-boilerplate" is TWO TIERS since 2026-08-04 (owner directive "additional
...
2026-07-30; the filename is only the trigger, the bytes still clear full
archive inspection) is
...
- **Several `.md` attachments (tolerance round, 2026-08-04):** `pickSkillDoc`
