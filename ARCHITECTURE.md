...
(isStaffSession: a verified staff provider + exact-label xl.net; Google needs no mv, Microsoft requires mv=true - its
...
# Signed in as staff (Google, or Microsoft with mv=true): /roadmap shows the staff hub, /roadmap/scorecard
