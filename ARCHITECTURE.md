...
depth ≤1, or the bare `.md` itself. Doc must clear 600 chars of prose after
...
admission guards apply. `DELETE .../[id]` — owner-or-admin hard delete = the
...
work_submissions   id uuid PK, user_id uuid NULL FK users ON DELETE SET NULL (published cards
                   ...
                   -- (withdraw/unpublish) removes the whole submission
